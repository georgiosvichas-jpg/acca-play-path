...
const mainNavItems = [
  ...
  { 
    ...
    icon: GraduationCap,
    children: [
      { path: "/practice-quiz", label: "Practice Quiz" },
      { path: "/spaced-repetition", label: "Spaced Repetition" },
      { path: "/question-browser", label: "Question Browser" },
    ]
  },
  { 
    path: "/flashcards", 
  ...
  { 
    ...
    icon: BarChart3,
    children: [
      { path: "/question-analytics", label: "Question Analytics" },
